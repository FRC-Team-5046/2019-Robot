...
import frc.robot.subsystems.Jacks;
import frc.robot.utilities.CompressorTools;
...
public class Robot extends TimedRobot {
  ...
  public static CompressorTools compressorTools = new CompressorTools();
  ...
  public void robotInit() {
    ...
    Robot.arm.setupSPARK();
    Robot.intake.setupEncoder();
    Robot.jacks.setupEncoder();
